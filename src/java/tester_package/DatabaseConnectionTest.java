...
public class DatabaseConnectionTest {
    ...
    public static void main(String[] args) {
        DatabaseConnectionTest database = new DatabaseConnectionTest();
    ...
    private void setUsername(String usernameValue) {
        DatabaseConnectionTest.setMySQLUsername(usernameValue);
    }
    ...
    private void setPassword(String passwordValue) {
        DatabaseConnectionTest.setMySQLPassword(passwordValue);
    }
